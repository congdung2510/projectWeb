...
//        processRequest(request, response);
        ...
        if (a == null) {
            ...
            String productID = request.getParameter("productidb");
            DAO dao = new DAO();
            Product p = dao.viewProduct(productID);
            dao.addToCart(Integer.parseInt(productID), 1, p.getName(), p.getPriceKM(), a.getId());
